...
public final class SubWildLookups
{
	...
	{
		STAIRS = new HashMap<>(15);
		SLABS = new HashMap<>(15);
		SPELEOS = new HashMap<>(11);
		...
		HashMap<Block, Block> dirtLookup = new HashMap<>(7);
		ORE_TABLE.put(Blocks.DIRT, dirtLookup);
		ORE_TABLE.put(SubWildBlocks.MOSSY_DIRT.get(), dirtLookup);
		ORE_TABLE.put(Blocks.COARSE_DIRT, dirtLookup);
		ORE_TABLE.put(Blocks.PODZOL, dirtLookup);
		ORE_TABLE.put(Blocks.FARMLAND, dirtLookup);
		ORE_TABLE.put(Blocks.MYCELIUM, dirtLookup);

		HashMap<Block, Block> tuffLookup = new HashMap<>(7);
		ORE_TABLE.put(Blocks.DEEPSLATE, tuffLookup);
		ORE_TABLE.put(Blocks.COBBLED_DEEPSLATE, tuffLookup);
		ORE_TABLE.put(Blocks.TUFF, tuffLookup);
		ORE_TABLE.put(Blocks.CALCITE, tuffLookup);
		ORE_TABLE.put(Blocks.CLAY, tuffLookup);
		ORE_TABLE.put(Blocks.MOSS_BLOCK, tuffLookup);

		STAIRS.put(Blocks.STONE, Blocks.STONE_STAIRS);
		STAIRS.put(Blocks.DEEPSLATE, SubWildBlocks.DEEPSLATE_STAIRS.get());
		...
		STAIRS.put(Blocks.COBBLED_DEEPSLATE, SubWildBlocks.DEEPSLATE_STAIRS.get());
		...
		SLABS.put(Blocks.DEEPSLATE, SubWildBlocks.DEEPSLATE_SLAB.get());
		...
		SLABS.put(Blocks.COBBLED_DEEPSLATE, SubWildBlocks.DEEPSLATE_SLAB.get());
		...
		SPELEOS.put(Blocks.DEEPSLATE, SubWildBlocks.DEEPSLATE_SPELEOTHEM.get());
		...
		SPELEOS.put(Blocks.COBBLED_DEEPSLATE, SubWildBlocks.DEEPSLATE_SPELEOTHEM.get());
		...
		put(dirtLookup, Tags.Blocks.ORES_COAL, SubWildBlocks.DIRT_COAL_ORE.get());
		put(dirtLookup, Tags.Blocks.ORES_IRON, SubWildBlocks.DIRT_IRON_ORE.get());
		put(dirtLookup, Tags.Blocks.ORES_GOLD, SubWildBlocks.DIRT_GOLD_ORE.get());
		put(dirtLookup, Tags.Blocks.ORES_LAPIS, SubWildBlocks.DIRT_LAPIS_ORE.get());
		put(dirtLookup, Tags.Blocks.ORES_REDSTONE, SubWildBlocks.DIRT_REDSTONE_ORE.get());
		put(dirtLookup, Tags.Blocks.ORES_DIAMOND, SubWildBlocks.DIRT_DIAMOND_ORE.get());
		put(dirtLookup, Tags.Blocks.ORES_EMERALD, SubWildBlocks.DIRT_EMERALD_ORE.get());

		put(tuffLookup, Tags.Blocks.ORES_COAL, SubWildBlocks.TUFF_COAL_ORE.get());
		put(tuffLookup, Tags.Blocks.ORES_IRON, SubWildBlocks.TUFF_IRON_ORE.get());
		put(tuffLookup, Tags.Blocks.ORES_GOLD, SubWildBlocks.TUFF_GOLD_ORE.get());
		put(tuffLookup, Tags.Blocks.ORES_LAPIS, SubWildBlocks.TUFF_LAPIS_ORE.get());
		put(tuffLookup, Tags.Blocks.ORES_REDSTONE, SubWildBlocks.TUFF_REDSTONE_ORE.get());
		put(tuffLookup, Tags.Blocks.ORES_DIAMOND, SubWildBlocks.TUFF_DIAMOND_ORE.get());
		put(tuffLookup, Tags.Blocks.ORES_EMERALD, SubWildBlocks.TUFF_EMERALD_ORE.get());
		...
		HashMap<Block, Block> iceLookup = new HashMap<>(7);
		put(iceLookup, Tags.Blocks.ORES_COAL, SubWildBlocks.ICE_COAL_ORE.get());
		put(iceLookup, Tags.Blocks.ORES_IRON, SubWildBlocks.ICE_IRON_ORE.get());
		put(iceLookup, Tags.Blocks.ORES_GOLD, SubWildBlocks.ICE_GOLD_ORE.get());
		put(iceLookup, Tags.Blocks.ORES_LAPIS, SubWildBlocks.ICE_LAPIS_ORE.get());
		put(iceLookup, Tags.Blocks.ORES_REDSTONE, SubWildBlocks.ICE_REDSTONE_ORE.get());
		put(iceLookup, Tags.Blocks.ORES_DIAMOND, SubWildBlocks.ICE_DIAMOND_ORE.get());
		put(iceLookup, Tags.Blocks.ORES_EMERALD, SubWildBlocks.ICE_EMERALD_ORE.get());
		put(ORE_TABLE, BlockTags.ICE, iceLookup);

		HashMap<Block, Block> snowLookup = new HashMap<>(7);
		put(snowLookup, Tags.Blocks.ORES_COAL, SubWildBlocks.SNOW_COAL_ORE.get());
		put(snowLookup, Tags.Blocks.ORES_IRON, SubWildBlocks.SNOW_IRON_ORE.get());
		put(snowLookup, Tags.Blocks.ORES_GOLD, SubWildBlocks.SNOW_GOLD_ORE.get());
		put(snowLookup, Tags.Blocks.ORES_LAPIS, SubWildBlocks.SNOW_LAPIS_ORE.get());
		put(snowLookup, Tags.Blocks.ORES_REDSTONE, SubWildBlocks.SNOW_REDSTONE_ORE.get());
		put(snowLookup, Tags.Blocks.ORES_DIAMOND, SubWildBlocks.SNOW_DIAMOND_ORE.get());
		put(snowLookup, Tags.Blocks.ORES_EMERALD, SubWildBlocks.SNOW_EMERALD_ORE.get());
		ORE_TABLE.put(Blocks.SNOW_BLOCK, snowLookup);
	...
	public static <V> void put(Map<Block, V> lookup, TagKey<Block> keys, V value)
	{
		BuiltInRegistries.BLOCK.getTag(keys).ifPresent(holders ->
			holders.forEach(holder -> lookup.put(holder.value(), value)));
	}
}
